      ...
      <div className="page-wrap">
        ...
        <div className="mb-12 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-xs font-semibold text-[var(--sea-ink)] hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors group"
          >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {NOTES.map((note) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="feature-card group rounded-2xl p-6 flex flex-col justify-between hover:border-indigo-400 dark:hover:border-indigo-500/40 transition-all duration-200"
            >
              <div>
                <div className="flex items-center justify-between gap-2 mb-3">
                  <span className="mono-meta text-indigo-600 dark:text-indigo-400 font-semibold text-[0.68rem]">
                    {note.category}
                  </span>
                ...
                <h3 className="text-base font-bold text-[var(--sea-ink)] group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors leading-snug mb-2.5">
                  {note.title}
                </h3>
              ...
              <div className="pt-3 border-t border-[var(--line-subtle)] flex items-center justify-between text-xs text-[var(--sea-ink-muted)]">
                ...
                <span className="cta-arrow text-indigo-600 dark:text-indigo-400 font-semibold text-sm">
                  →
                </span>
              </div>
            </a>
